...
const ChatListRow = ({ chatId }: Props) => {
  ...
  const row = (message?: Message) => (
    <div
      ...
      className="flex p-5 items-center space-x-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-700 rounded-md duration-200"
    >
      <UserAvatar
